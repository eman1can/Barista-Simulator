...
{
    public class FaucetInteraction : MonoBehaviour, IInteractable, IHoverableEnter
    {
        [Header("Handle Variables")]
        [SerializeField]
        ...
        public void OnInteract()
        {
            ...
            {
                StartStream();
                _info.infoStrings[0] = "Turn Off Faucet";
            }
            else
            {
                _info.infoStrings[0] = "Turn On Faucet";
            }
            _info.interactionGUI.UpdateStrings(_info.infoStrings, _info.infoCount);
        }
