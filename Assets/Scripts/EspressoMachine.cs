 ...
 */
public class EspressoMachine : IInteractable {
    ...
    private LiquidContainer _dripTray;
    private LiquidContainer _cup;
    ...
    public void AddWaterContainer(HeldObject hObject) {
        ...
        _waterContainer = hObject.GetComponent<LiquidContainer>();
    ...
    public void AddDripTray(HeldObject hObject) {
        ...
        _dripTray = hObject.GetComponent<LiquidContainer>();
    ...
    public void AddCup(HeldObject hObject) {
        ...
        _cup = hObject.GetComponent<LiquidContainer>();
    ...
    private void Update() {
        ...
        if (currentLayer == Utils.Layers.Selected) {
            PushUpdatedStates();
        }
    }
}